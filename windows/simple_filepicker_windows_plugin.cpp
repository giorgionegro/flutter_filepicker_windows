...
namespace simple_filepicker_windows {
	...
	// static
	void SimpleFilepickerWindowsPlugin::RegisterWithRegistrar(
		...
		std::unique_ptr<SimpleFilepickerWindowsPlugin> plugin =
			std::make_unique<SimpleFilepickerWindowsPlugin>();
	...
	SimpleFilepickerWindowsPlugin::SimpleFilepickerWindowsPlugin() {}
	SimpleFilepickerWindowsPlugin::~SimpleFilepickerWindowsPlugin() {}
	void SimpleFilepickerWindowsPlugin::HandleMethodCall(
		...
		if (method_call.method_name().compare("showFilePicker") == 0) {
			...
			int string_length = (int)allowed_types_string.length() + 1;
